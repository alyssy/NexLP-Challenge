def setup_dictionary():
	# create Hash table to store emotion keyword dictionary
	ID = {}
	ID = load_dictionary(ID, "happy")
	ID = load_dictionary(ID, "sad")
	ID = load_dictionary(ID, "angry")
	ID = load_dictionary(ID, "irritated")
	ID = load_dictionary(ID, "appreciative")
	return ID
	
def load_dictionary(ID, keyword):
	if (keyword == "happy"):
		ID = load_happy(ID)
	elif (keyword == "sad"):
		ID = load_sad(ID)
		...
		ID = load_angry(ID)
	elif (keyword == "irritated"):
		ID = load_irritated(ID)
	elif (keyword == "appreciative"):
		ID = load_appreciative(ID)
	return ID
